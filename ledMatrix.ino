...
#define WIDTH 12              // ширина матрицы
...
#define D_EFFECT_SPEED 50     // скорость эффектов по умолчанию (мс)
...
int AUTOPLAY_PERIOD = 120;     // время между авто сменой режимов (секунды)
