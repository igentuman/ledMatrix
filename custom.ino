...
#define MODES_AMOUNT 22   // количество кастомных режимов (которые переключаются сами или кнопкой)

void customModes() {
  globalBrightness = 254;
  switch (thisMode) {
    case 0: fillString(" NO  WAR ", CRGB::Red);
      break;
    case 1: fillString(" MAKE  LOVE ", CRGB::Green);
      break;
    case 2: fillString(" WE  ARE  FRIENDS ", CRGB::Blue);
      break;
    case 3: flagsRoutine(3);
      break;
    case 4: snowRoutine(4);
      break;
    case 5: lavaNoise(5);
      break;
    case 6: plasmaNoise(6);
      break;
    case 7: rainbowNoise(7);
      break;
    case 8: rainbowStripeNoise(8);
      break;
    case 9: zebraNoise(9);
      break;
    case 10: forestNoise(10);
      break;
    case 11: oceanNoise(11);
      break;
    case 12: snowRoutine(12);
      break;
    case 13: sparklesRoutine(13);
      break;
    case 14: matrixRoutine(14);
      break;
    case 15: starfallRoutine(15);
      break;
    case 16: fireRoutine(16);
      break;
    case 17: ballsRoutine(17);
      break;
    case 18: matrixRoutine(18);
      break;
    case 19: rainbowDiagonalRoutine(19);
      break;
    case 20: fireRoutine(20);
      break;
    case 21: madnessNoise(21);
      break;
    case 22: cloudNoise(22);
      break;
  }
}
